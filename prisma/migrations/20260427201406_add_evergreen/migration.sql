...
INSERT INTO "new_ContentPiece" ("ageBand", "approvedAt", "body", "createdAt", "dailyGridId", "generatedAt", "id", "publishDate", "question1", "question2", "question3", "status", "title", "topicCategory") SELECT "ageBand", "approvedAt", "body", "createdAt", "dailyGridId", "generatedAt", "id", "publishDate", "question1", "question2", "question3", "status", "title", "topicCategory" FROM "ContentPiece";
