...
INSERT INTO "new_ContentPiece" ("ageBand", "approvedAt", "body", "contentType", "createdAt", "dailyGridId", "evergreen", "generatedAt", "id", "publishDate", "question1", "question2", "question3", "status", "title", "topicCategory") SELECT "ageBand", "approvedAt", "body", "contentType", "createdAt", "dailyGridId", "evergreen", "generatedAt", "id", "publishDate", "question1", "question2", "question3", "status", "title", "topicCategory" FROM "ContentPiece";
